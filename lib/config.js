...
export const API_KEY = {
  ...
  publishComment: HEADER + "/comment/publish", //发布评论
  checkTextLegal: HEADER + "/wx/checkTextLegal", //检测发布文字内容是否违规
  checkImageLegal: HEADER + "/wx/checkImageLegal", //检测发布图片内容是否违规
}